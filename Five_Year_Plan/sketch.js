...
$(document).ready(function() {
  ...
  $("#back").click(function() {
    ...
    $("#menu").hide();
    $("#guide-to-PC").hide();
    $(".hover-text .hover-text-bottom").hide();
    $("#scroll-page").show();

    // window.location.hash == "#page-0";
    // window.location.replace(window.location.href);
    pageable.scrollToAnchor("#page-1");
...
function draw() {
  ...
  if (loading) {
    ...
    if (element_in_view[4]) { // task1 - blank
      if (!first_reach_element[5]) { //upscrolled to task1.
        // $(".task-highlight").removeClass("task-highlight-add");
        $(".task-gdp-highlight").removeClass("task-gdp-highlight-add");
    ...
    //
    // if (element_in_view[5]) { // task 2. show all the keywords.
    ...
    // if (element_in_view[6]) { // task 2 - blank
    ...
    if (element_in_view[5]) { // task 3 - info1.
      if (!first_reach_element[6]) { //upscrolled to task1.
        first_reach_element[6] = true;
      }
      if (first_reach_element[5]) {
      ...
      animationNodes("Task", 8);
      $(".task-gdp-highlight").addClass("task-gdp-highlight-add");
      //do nothing.
    }

    if (element_in_view[6]) { // task 3 - info1 - blank.
      if (!first_reach_element[7]) { //upscrolled to task1.
        first_reach_element[7] = true;
        $(".task-industrial-highlight").removeClass("task-industrial-highlight-add");
        $(".task-gdp-highlight").addClass("task-gdp-highlight-add");
      }
      if (first_reach_element[6]) {
        first_reach_element[6] = false;
    ...
    if (element_in_view[7]) { // task 4 - info2.
      if (!first_reach_element[8]) { //upscrolled to task1.
        // $(".text-content, section-content").removeClass("manufacturing-color");
        // shiftMode("titles", "quick");
      ...
      animationNodes("Task", 8);
      $(".task-gdp-highlight").removeClass("task-gdp-highlight-add");
      $(".task-industrial-highlight").addClass("task-industrial-highlight-add");
      //do nothing.
    }

    if (element_in_view[8]) { // task 4 - info2 - blank.
      if (!first_reach_element[9]) { //upscrolled to task1.
        $(".text-content, section-content").removeClass("manufacturing-color");
        shiftMode("titles", "quick");
        $(".section-content, .text-content").addClass("task-color");
        $(".task-highlight").addClass("task-highlight-add");
        $(".task-industrial-highlight").addClass("task-industrial-highlight-add");
        first_reach_element[9] = true;
      }
      if (first_reach_element[8]) {
        first_reach_element[8] = false;
        first_reach_element[7] = true;
      }
      animationNodes("Task", 8);
      //do nothing.
    ...
    if (element_in_view[9]) { // Manufacturing1. show all texts.
      if (!first_reach_element[10]) { //upscrolled to task1.
        first_reach_element[10] = true;
      }
      if (first_reach_element[9]) {
        first_reach_element[9] = false;
        first_reach_element[8] = true;
        $(".task-highlight").removeClass("task-highlight-add");
        $(".task-industrial-highlight-add").removeClass("task-industrial-highlight-add");
        $(".task-gdp-highlight").removeClass("task-gdp-highlight-add");
    ...
    if (element_in_view[10]) { // Manufacturing1 - blank
      if (!first_reach_element[11]) { //upscrolled to task1.
        first_reach_element[11] = true;
        emptyNodes();
        shiftMode("texts", "medium");
        highlightTexts("Manufacturing", "manufacturing-color");
      }
      if (first_reach_element[10]) {
        first_reach_element[10] = false;
        first_reach_element[9] = true;
        //do nothing.
      }
    }

    if (element_in_view[11]) { // Manufacturing2. show titles and connections.
      if (!first_reach_element[12]) {
        first_reach_element[12] = true;
      }
      if (first_reach_element[11]) {
        shiftMode("titles", "quick");
        first_reach_element[11] = false;
        first_reach_element[10] = true;
      }
    ...
    if (element_in_view[12]) { // Manufacturing2 - blank.
      if (!first_reach_element[13]) {
        first_reach_element[13] = true;
        $("#manufacture-text1-story").hide();
        $(".star").remove();
      }
      if (first_reach_element[12]) {
        first_reach_element[12] = false;
        first_reach_element[11] = true;
      }
      animationNodes("Manufacturing", 13);
    }

    if (element_in_view[13]) { // Manufacturing3 - quote.
      if (!first_reach_element[14]) {
        first_reach_element[14] = true;

      }
      if (first_reach_element[13]) {
        first_reach_element[13] = false;
        first_reach_element[12] = true;
        setTimeout(function() {
          var mx1 = $("#chapterContentDiv031").offset().left + 5;
          var my1 = $("#chapterContentDiv031").offset().top - $(window).scrollTop() + 15;
        ...
        if (windowW>900) {
        setTimeout(function() {
          var left = $("#chapterContentDiv031").offset().left + 15;
          var top = $("#chapterContentDiv031").offset().top - $(window).scrollTop() + 25;
          $("#manufacture-text1-story").css({
            'position': 'fixed',
            'top': top,
            'left': left
          }).show();
    ...
    if (element_in_view[14]) { // Manufacturing3 - quote - blank.
      if (!first_reach_element[15]) {
        first_reach_element[15] = true;
        $(".star").remove();
        $("#manufacture-text1-story").hide();
      }
      if (first_reach_element[14]) {
        first_reach_element[14] = false;
        first_reach_element[13] = true;
        //do mobile things.
        if (windowW<900) {
        setTimeout(function() {
    ...
    if (element_in_view[15]) { // Manufacturing4 - info1.
      if (!first_reach_element[16]) {
        first_reach_element[16] = true;


      }
      if (first_reach_element[15]) {
        first_reach_element[15] = false;
        first_reach_element[14] = true;
        $("#manufacture-text1-story").hide();
      }
      animationNodes("Manufacturing", 13);
    ...
    if (element_in_view[16]) { // Manufacturing4 - info1 - blank.
      if (!first_reach_element[17]) {
        first_reach_element[17] = true;
        $("#manufacturing-star2").remove();
        $("#manufacture-text2-story").hide();
      }
      if (first_reach_element[16]) {
        first_reach_element[16] = false;
        first_reach_element[15] = true;
        //do nothing.
      }
      animationNodes("Manufacturing", 13);
    ...
    if (element_in_view[17]) { // Manufacturing5 - info2
      if (!first_reach_element[18]) {
        first_reach_element[18] = true;
        // $(".text-content, section-content").removeClass("agriculture-color");
        // shiftMode("titles", "quick");
      }
      if (first_reach_element[17]) {
        first_reach_element[17] = false;
        first_reach_element[16] = true;


        setTimeout(function() {
          $("#chapterContentDiv751").addClass("medium");
          var mx1 = $("#chapterContentDiv751").offset().left + 5;
          var my1 = $("#chapterContentDiv751").offset().top - $(window).scrollTop() + 50;
          createDiv().position(mx1, my1).id("manufacturing-star1").class("star").style("position", "fixed").addClass("manufacturing-star");
          $("#chapterContentDiv751").removeClass("medium");
        }, 800);

        setTimeout(function() {
          $("#chapterContentDiv751").addClass("medium");
          var left = $("#chapterContentDiv751").offset().left + fypDivWidth - hoverWidth;
          var top = $("#chapterContentDiv751").offset().top - $(window).scrollTop() + 65;
          $("#chapterContentDiv751").removeClass("medium");
          textAnimation("3s");
        }, 1000);
    ...
    if (element_in_view[18]) { // Manufacturing3 - quote - blank.
      if (!first_reach_element[19]) {
        first_reach_element[19] = true;
        $(".text-content, section-content").removeClass("agriculture-color");
        shiftMode("titles", "quick");
      }
      if (first_reach_element[18]) {
        first_reach_element[18] = false;
        first_reach_element[17] = true;
        //do mobile thing.

      if (windowW<900) {
        setTimeout(function() {
          // var right = $("#chapterContentDiv751").offset().right + 15;
          var top = $("#chapterContentDiv751").offset().top - $(window).scrollTop() + 65;
    ...
    if (element_in_view[19]) { // agriculture1. show all texts , comparing with manufacture.
      if (!first_reach_element[20]) { //upscrolled to task1.
        first_reach_element[20] = true;
        //do nothing.
      }
      if (first_reach_element[19]) {
        $("#manufacture-text2-story").hide();
        $(".star").remove();
        first_reach_element[19] = false;
        first_reach_element[18] = true;
        emptyNodes();
        shiftMode("texts", "medium");
        highlightTexts("Manufacturing", "manufacturing-color");
    ...
    if (element_in_view[20]) { // agriculture1 - blank.
      if (!first_reach_element[21]) { //upscrolled to task1.
        first_reach_element[21] = true;
        emptyNodes();
        shiftMode("texts", "medium");
        highlightTexts("Manufacturing", "manufacturing-color");
        highlightTexts("Agriculture", "agriculture-color");
      }
      if (first_reach_element[20]) {
        first_reach_element[20] = false;
        first_reach_element[19] = true;
        //do nothing.
      }
    }

    if (element_in_view[21]) { // agriculture2. show titles and connections.
      if (!first_reach_element[22]) { //upscrolled to task1.
        first_reach_element[22] = true;
      }
      if (first_reach_element[21]) {
        first_reach_element[21] = false;
        first_reach_element[20] = true;
    ...
    if (element_in_view[22]) { // agriculture2 - with lines -  blank.
      if (!first_reach_element[23]) { //upscrolled to task1.
        first_reach_element[23] = true;
      }
      if (first_reach_element[22]) {
        first_reach_element[22] = false;
        first_reach_element[21] = true;
        //do nothing.
      }
      animationNodes("Agriculture", 9);
    ...
    if (element_in_view[23]) { // agriculture3 - info1.
      if (!first_reach_element[24]) { //upscrolled to task1.
        first_reach_element[24] = true;
        // $("#agriculture-text1-story").hide();
        // $(".star").remove();
      }
      if (first_reach_element[23]) {
        first_reach_element[23] = false;
        first_reach_element[22] = true;
        //do nothing.
      }
      animationNodes("Agriculture", 9);
    ...
    if (element_in_view[24]) { // agriculture3 - info1 - blank.
      if (!first_reach_element[25]) { //upscrolled to task1.
        first_reach_element[25] = true;
        $("#agriculture-text1-story").hide();
        $(".star").remove();
      }
      if (first_reach_element[24]) {
        first_reach_element[24] = false;
        first_reach_element[23] = true;
        //do nothing.
      }
      animationNodes("Agriculture", 9);
    ...
    if (element_in_view[25]) { // agriculture4 - quote.
      if (!first_reach_element[26]) { //upscrolled to task1.
        first_reach_element[26] = true;
        // $("#agriculture-text1-story").hide();
        // $(".star").remove();
        //do nothing.
      }
      if (first_reach_element[25]) {
        first_reach_element[25] = false;
        first_reach_element[24] = true;

        setTimeout(function() {
          $("#sectionContentDiv51").addClass("large");
          $("#chapterContentDiv511").addClass("medium-s");
          var mx1 = $("#chapterContentDiv511").offset().left + 5;
          agricultureTop = $("#chapterContentDiv511").offset().top - $(window).scrollTop() + 65;
          createDiv().position(mx1, agricultureTop).id("manufacturing-star1").class("star").style("position", "fixed").addClass("manufacturing-star");
    ...
    if (element_in_view[26]) { // agriculture4 - quote - blank.
      if (!first_reach_element[27]) { //upscrolled to task1.
        first_reach_element[27] = true;
        $("#agriculture-text1-story").hide();
        $(".star").remove();
        //do nothing.
      }
      if (first_reach_element[26]) {
        first_reach_element[26] = false;
        first_reach_element[25] = true;
        //do nothing.
      }
      animationNodes("Agriculture", 9);
    ...
    if (element_in_view[27]) { // agriculture4 -info2.
      if (!first_reach_element[28]) { //upscrolled to task1.
        first_reach_element[28] = true;
      }
      if (first_reach_element[27]) {
        first_reach_element[27] = false;
        first_reach_element[26] = true;
        $("#agriculture-text1-story").hide();
        $(".star").remove();
        //do nothing.
    ...
    if (element_in_view[28]) { // agriculture4 -info2.
      if (!first_reach_element[29]) { //upscrolled to task1.
        first_reach_element[29] = true;
      }
      if (first_reach_element[28]) {
        first_reach_element[28] = false;
        first_reach_element[27] = true;
        //do nothing.
      }
      animationNodes("Agriculture", 9);
    ...
    if (element_in_view[29]) { //jump to exlore page.
      if (windowW>900) {
      $(".star").remove();
      $("#agriculture-text1-story").hide();
      $("#scroll-page").hide();
